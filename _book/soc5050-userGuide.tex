...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{>}\StringTok{ }\KeywordTok{library}\NormalTok{(ggplot2)}
\NormalTok{>}\StringTok{ }\KeywordTok{str}\NormalTok{(mpg)}
\NormalTok{Classes ‘tbl_df’, ‘tbl’ and }\StringTok{'data.frame'}\NormalTok{:}\StringTok{   }\DecValTok{234} \NormalTok{obs. of  }\DecValTok{11} \NormalTok{variables:}
\StringTok{ }\ErrorTok{$}\StringTok{ }\NormalTok{manufacturer:}\StringTok{ }\NormalTok{chr  }\StringTok{"audi"} \StringTok{"audi"} \StringTok{"audi"} \StringTok{"audi"} \NormalTok{...}
 \NormalTok{$}\StringTok{ }\NormalTok{model       :}\StringTok{ }\NormalTok{chr  }\StringTok{"a4"} \StringTok{"a4"} \StringTok{"a4"} \StringTok{"a4"} \NormalTok{...}
 \NormalTok{$}\StringTok{ }\NormalTok{displ       :}\StringTok{ }\NormalTok{num  }\FloatTok{1.8} \FloatTok{1.8} \DecValTok{2} \DecValTok{2} \FloatTok{2.8} \FloatTok{2.8} \FloatTok{3.1} \FloatTok{1.8} \FloatTok{1.8} \DecValTok{2} \NormalTok{...}
 \NormalTok{$}\StringTok{ }\NormalTok{year        :}\StringTok{ }\NormalTok{int  }\DecValTok{1999} \DecValTok{1999} \DecValTok{2008} \DecValTok{2008} \DecValTok{1999} \DecValTok{1999} \DecValTok{2008} \DecValTok{1999} \DecValTok{1999} \DecValTok{2008} \NormalTok{...}
 \NormalTok{$}\StringTok{ }\NormalTok{cyl         :}\StringTok{ }\NormalTok{int  }\DecValTok{4} \DecValTok{4} \DecValTok{4} \DecValTok{4} \DecValTok{6} \DecValTok{6} \DecValTok{6} \DecValTok{4} \DecValTok{4} \DecValTok{4} \NormalTok{...}
 \NormalTok{$}\StringTok{ }\NormalTok{trans       :}\StringTok{ }\NormalTok{chr  }\StringTok{"auto(l5)"} \StringTok{"manual(m5)"} \StringTok{"manual(m6)"} \StringTok{"auto(av)"} \NormalTok{...}
 \NormalTok{$}\StringTok{ }\NormalTok{drv         :}\StringTok{ }\NormalTok{chr  }\StringTok{"f"} \StringTok{"f"} \StringTok{"f"} \StringTok{"f"} \NormalTok{...}
 \NormalTok{$}\StringTok{ }\NormalTok{cty         :}\StringTok{ }\NormalTok{int  }\DecValTok{18} \DecValTok{21} \DecValTok{20} \DecValTok{21} \DecValTok{16} \DecValTok{18} \DecValTok{18} \DecValTok{18} \DecValTok{16} \DecValTok{20} \NormalTok{...}
 \NormalTok{$}\StringTok{ }\NormalTok{hwy         :}\StringTok{ }\NormalTok{int  }\DecValTok{29} \DecValTok{29} \DecValTok{31} \DecValTok{30} \DecValTok{26} \DecValTok{26} \DecValTok{27} \DecValTok{26} \DecValTok{25} \DecValTok{28} \NormalTok{...}
 \NormalTok{$}\StringTok{ }\NormalTok{fl          :}\StringTok{ }\NormalTok{chr  }\StringTok{"p"} \StringTok{"p"} \StringTok{"p"} \StringTok{"p"} \NormalTok{...}
 \NormalTok{$}\StringTok{ }\NormalTok{class       :}\StringTok{ }\NormalTok{chr  }\StringTok{"compact"} \StringTok{"compact"} \StringTok{"compact"} \StringTok{"compact"} \NormalTok{...}
\end{Highlighting}
\end{Shaded}
